...
def parseArgs():
    ...
    # Tree algorithms
    argParser.add_argument('algorithm', choices=["mta", "npaths", "bfs", "rsta", "da", "none"], help="tree algorithm to run on graph (or none).")
    ...
    argParser.add_argument("-s", "--save", default=False, action="store_true", help="Save a graphml copy of the generated graph")
