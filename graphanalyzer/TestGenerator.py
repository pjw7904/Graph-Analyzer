...
from networkx import NetworkXError, is_isomorphic, write_graphml
from networkx.utils import graphs_equal
import GraphGenerator

def generateRegularGraphs(numOfGraphs, numNodes, sharedDegree):
    graphsToSave = [] # Turn these into graphml files
    graphLocation = f"C:/Users/peter/Documents/research/mtp-analysis/graphs/graphml/regular_{numNodes}_node"
        ...
        while(currentAttempt != maxAttempts):
            ...
            if(GraphGenerator.isValidGraph(candidateGraph)):
                for savedGraph in graphsToSave:
                    ...
                    write_graphml(candidateGraph, graphLocation.format(f"regular_{numNodes}_{sharedDegree}_{graphNum+1}"))
                    break
            else:
                currentAttempt += 1
